...
#     # Explicit join condition to relate through Service_Professional
#     service_requests = db.relationship(
#         'Service_Request',
#         primaryjoin="Service.id == Service_Professional.service_id",
#         secondaryjoin="Service_Professional.id == Service_Request.service_professional_id",
#         secondary="service_professional",  # Join via the 'service_professional' table
#         backref='service', 
#         lazy=True
#     )
...
#     service_requests = db.relationship('Service_Request', backref='service_professional', lazy=True)
...
#     remark_id = db.Column(db.Integer, db.ForeignKey('remarks.id'), nullable=True)
